...
class FuxModel
{
    ...
    /**
     * @param $dtm FuxModel | Model: Riferimento alla classe Model che rappresenta la tabella con cui fare la join
     ...
     * </p>
     */
    public function listWithJoin($dtm, string $onClause = null, $where = '1', $table1NeededFields = "*", $table2NeededFields = "*", $joinType = "")
    {
        global $mysqli;
